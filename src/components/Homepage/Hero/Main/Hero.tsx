...
export function Hero() {
  ...
  return (
    <div className="flex relative lg:items-center pb-12 lg:pb-16 w-full pt-36 items-center md:items-start lg:pt-12 lg:mt-0 px-8 md:px-12 min-h-[100vh] md:min-h-[20vh] lg:min-h-[110vh] justify-center gap-6">
      ...
      <Image
        ...
        alt="House"
      />
      <div className="absolute lg:-bottom-[8rem] bottom-4 mx-4  lg:mx-auto">
        <Presale/>
      </div>
    </div>
  );
