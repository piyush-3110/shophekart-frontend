...
export default function FloatingNavbar() {
  ...
  return (
    <nav
      className={`sticky lg:flex lg:items-center lg:justify-around top-0 z-[4] left-0 transition-transform duration-300 ease-in-out bg-white shadow-md py-2 px-6 ${
