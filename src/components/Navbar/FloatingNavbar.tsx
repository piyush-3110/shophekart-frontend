...
export default function FloatingNavbar() {
  ...
  return (
    <nav
      className={`sticky lg:flex lg:items-center w-full lg:justify-around top-0 z-[40] left-0 transition-transform duration-300 ease-in-out bg-white py-2 px-6 ${
      ...
      >
        {menuOpen && (
          <>
            ...
            <Link
              href="https://product.shophekart.com/cshopCard"
              onClick={handleLinkClick}
              className="flex items-center space-x-2 text-black hover:bg-blue-500 hover:text-white py-2 px-4 rounded"
            >
              <FaFileAlt />
