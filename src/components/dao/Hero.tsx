...
import { CreateProposalModal } from "./CreateProposalModal"; // Import the modal component
...
export function Hero() {
  ...
  return (
    <div className="flex overflow-x-hidden relative lg:items-center pb-12 lg:pb-16 w-full items-center md:items-start lg:mt-0 px-8 md:px-12 min-h-[100vh] md:min-h-[20vh] lg:min-h-[90vh] justify-center gap-6">
